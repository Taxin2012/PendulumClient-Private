...
{
    public static class CMV2_Utils
    {
        ...
        public static Color RGBMultipliedClamped(this Color c, float m) => new Color() { r = Math.Min(c.r * m, 1f), g = Math.Min(c.g * m, 1f), b = Math.Min(c.b * m, 1f), a = c.a };
