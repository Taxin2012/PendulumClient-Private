    ...
    public static class NetworkManagerHooks
    {
        ...
        public static void EventHandlerA(Player player)
        {
            if (!SeenFire)
            {
                ...
                PendulumLogger.Log("EH-A fired first");
            }
        ...
        public static void EventHandlerB(Player player)
        {
            if (!SeenFire)
            {
                ...
                PendulumLogger.Log("EH-B fired first");
            }
        ...
        private static void AddDelegate(VRCEventDelegate<Player> field, Action<Player> eventHandler)
        {
