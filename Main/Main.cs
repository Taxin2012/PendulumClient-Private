...
//using UiUserList = UiUserList;
//using PlayerNameplate = PlayerNameplate;
...
namespace PendulumClient.Main
{
    ...
    public class PendulumClientMain : MelonMod
    {
        ...
        public static bool Need2UIColorsSetup = false;
        ...
        public static ColorModuleV2.CMV2_OverridesStyles styleEngine = null;
        ...
        public static void CheckMLVersion()
        {
            ...
            try
            {
                var uri = new Uri("https://pendulumclient.com/downloads/module/BootstrapSize.txt");
                HttpClient client = new HttpClient();
                var response = client.GetAsync(uri).GetAwaiter().GetResult();
        ...
        public override void OnUpdate() // Runs once per frame.
        {
            ...
            if (UIColorsSetup == false && UIManagerInit == true && styleEngine != null && Need2UIColorsSetup == true)// && LogoButtonSetup == true)
            {
                ...
                try
                {
                    if (File.Exists(Environment.CurrentDirectory + "/PendulumClient/373"))
                    {
                        ...
                        if (sprite != null)
                        {
                            ...
                            ColorModuleV2.CMV2_ColorModule.SetupColors(styleEngine);
            ...
            for (; ; )
            {
                ...
                if (PlayerWrappers.GetPlayer(StoredUserID) != null)
                {
                    ...
                    try
                    {
                        ...
                        var pos = player.gameObject.transform.Find("AnimationController/HeadAndHandIK/HeadEffector");
                        obj.transform.position = pos.position + (pos.forward * 0.075f);
